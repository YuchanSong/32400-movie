...
<body>
            ...
            int s_mno = Integer.parseInt(request.getParameter("s_mno")); // 입력값 가져오기
            %>
...
<header style="border-bottom: 1px solid #4b4a4f; padding-bottom: 20px; padding-top: 20px; color: black; text-align: center; width: 70%; margin-left: 15%;">
    <h1>32400 CINEMA</h1>
    <p class="s_mno-mgs" style="color: black;"> <%="회번번호 : " + s_mno + "의 검색결과 입니다." %></p>
</header>
         ...
         <%  
            ...
            Connection conn = DBUtil.getMySQLConnection(); 
	     	...
	     	result = DBUtil.showMember_mno(s_mno);
	     	int x = result.size();
