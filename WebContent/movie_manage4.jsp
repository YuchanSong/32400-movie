...
<head>
  ...
  <script type="text/javascript">
    ...
    function bt_click1(){
    	location.href ="movie_manage0.jsp";
    }
    function bt_click2(){
    	if(rIndex == 0){
    		alert("삭제 할 영화를 선택해주십시오.");
    	}
    	else{
    		mnum = document.getElementsByTagName('td')[6*rIndex].childNodes[0].nodeValue;
    		location.href ="delete_movie.jsp?mnum="+mnum;
    	}
    }
...
<header style="border-bottom: 1px solid #4b4a4f; padding-bottom: 20px; padding-top: 20px; color: black; text-align: center; width: 50%; margin-left: 25%;">
  <h1>32400 CINEMA</h1>
  <p class="login-mgs" style="color: black;">영화 관리 - 영화 목록</p>
</header>
...
%>
  <table id="myTable" style="width:50%; margin-left: 25%; padding-top: 0; text-align: center ; color: black; border: 0 none; border-bottom: 1px solid #4b4a4f; ">
	...
	<a href="#" class="button-3d" onclick="bt_click1()">이전</a>
  	<a href="#" class="button-3d" onclick="bt_click2()">영화 삭제</a>
  <script type="text/javascript">
