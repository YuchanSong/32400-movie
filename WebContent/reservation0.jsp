  ...
  <script type="text/javascript">
    ...
    function bt_click(){
    	if(rIndex == 0){
    		...
    		location.href ="reservation1.jsp?tno="+rIndex;
    	}
    }
...
<header style="border-bottom: 1px solid #4b4a4f; padding-bottom: 20px; padding-top: 20px; color: black; text-align: center; width: 50%; margin-left: 25%;">
  <h1>32400 CINEMA</h1>
  <p class="login-mgs" style="color: black;"> 영화 예매</p>
</header>
...
reservation_DB.loadConnect(); 
 ...
 result = reservation_DB.selectTimeTable();
 int x = result.size();
...
%>
  ...
  <a href="#" class="button-3d">이전</a>
  <a id="bt" class="button-3d" onclick="bt_click()">좌석선택</a><br>
