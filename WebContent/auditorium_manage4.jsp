...
<head>
  ...
  <script type="text/javascript">
    ...
    function bt_click2(){
    	if(rIndex == 0){
    		alert("삭제 할 상영관를 선택해주십시오.");
    	}
    	else{
    		ano = document.getElementsByTagName('td')[2*rIndex].childNodes[0].nodeValue;
    		location.href ="delete_auditorium.jsp?ano="+ano;
    	}
    }
...
<header style="border-bottom: 1px solid #4b4a4f; padding-bottom: 20px; padding-top: 20px; color: black; text-align: center; width: 50%; margin-left: 25%;">
  <h1>32400 CINEMA</h1>
  <p class="login-mgs" style="color: black;">상영관 관리 - 상영관 삭제</p>
</header>
...
%>
  ...
  <a href="#" class="button-3d" onclick="bt_click2()">상영관 삭제</a>
  <script type="text/javascript">
