...
<head>
    ...
    function bt_click1(){
    	location.href ="timetable_manage1.jsp";
    }
    function bt_click2(){
    	location.href ="timetable_manage2.jsp";
    }
    function bt_click3(){
    	location.href ="timetable_manage3.jsp";
    }
    function bt_click4(){
    	location.href ="timetable_manage4.jsp";
    }
    function bt_click5(){
...
<header style="border-bottom: 1px solid #4b4a4f; padding-bottom: 20px; padding-top: 20px; color: black; text-align: center; width: 50%; margin-left: 25%;">
    <h1>32400 CINEMA</h1>
    <p class="adminin-mgs" style="color: black;"> 32400 CINEMA 관리자 모드 - 배정 관리</p>
...
<fieldset class="admin-form" style="width:50%; margin-left: 25%; padding-top: 0; text-align: center ; border: 0 none; border-bottom: 1px solid #4b4a4f; ">
    <br>
    <a href="#" class="button-3d" onclick="bt_click1()">배정 목록</a><br>
    <a href="#" class="button-3d" onclick="bt_click2()">배정 등록</a><br>
    <a href="#" class="button-3d" onclick="bt_click3()">배정 수정</a><br>
    <a href="#" class="button-3d" onclick="bt_click4()">배정 삭제</a><br>
