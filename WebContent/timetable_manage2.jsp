...
<header style="border-bottom: 1px solid #4b4a4f; padding-bottom: 20px; padding-top: 20px; color: black; text-align: center; width: 50%; margin-left: 25%;">
  <h1>32400 CINEMA</h1>
  <p class="login-mgs" style="color: black;">배정 관리 - 배정 등록</p>
</header>
<body>
<div class="box">
	<form  action="timetable_manage2-0.jsp">
	    영화 번호 :	<input type="text" name="mnum" size=10 style="margin:auto;"><br>
	    상영관 번호 :	<input type="text" name="ano" size=10 style="margin:auto;"><br>
	    날짜 (yyyy.mm.dd):	<input type="text" name="od" size=10 style="margin:auto;"><br>
	    시간 (hh:mm):	<input type="text" name="ot" size=10 style="margin:auto;"><br><br><br><br>
	    <a class="button-3d" onclick="bt_click1()">이전</a>
		<input type="submit" class="button-3d" value="배정등록">
	</form>
</div>
<br><br>
</body>
