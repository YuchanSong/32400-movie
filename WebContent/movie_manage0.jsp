...
<head>
    ...
    function bt_click1(){
    	location.href ="movie_manage1.jsp";
    }
    function bt_click2(){
    	location.href ="movie_manage2.html";
    }
    function bt_click3(){
    	location.href ="movie_manage3.html";
    }
    function bt_click4(){
    	location.href ="movie_manage4.jsp";
    }
    function bt_click5(){
...
<header style="border-bottom: 1px solid #4b4a4f; padding-bottom: 20px; padding-top: 20px; color: black; text-align: center; width: 50%; margin-left: 25%;">
    <h1>32400 CINEMA</h1>
    <p class="adminin-mgs" style="color: black;"> 32400 CINEMA 관리자 모드 - 영화 관리</p>
...
<fieldset class="admin-form" style="width:50%; margin-left: 25%; padding-top: 0; text-align: center ; border: 0 none; border-bottom: 1px solid #4b4a4f; ">
    <br>
    <a href="#" class="button-3d" onclick="bt_click1()">영화 목록</a><br>
    <a href="#" class="button-3d" onclick="bt_click2()">영화 등록</a><br>
    <a href="#" class="button-3d" onclick="bt_click3()">영화 수정</a><br>
    <a href="#" class="button-3d" onclick="bt_click4()">영화 삭제</a><br>
